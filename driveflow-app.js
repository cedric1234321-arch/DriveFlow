...
function resetTransientUi(){
  document.querySelectorAll(".sheet.open").forEach(x=>{x.classList.remove("open");x.setAttribute("aria-hidden","true")});
  const backdrop=$("sheetBackdrop");if(backdrop)backdrop.hidden=true;
  const compare=$("comparePage");if(compare){compare.classList.remove("open");compare.setAttribute("aria-hidden","true")}
...
function switchView(v){
  ...
  const fab=$("openSession");if(fab)fab.style.display=v==="today"?"block":"none";
