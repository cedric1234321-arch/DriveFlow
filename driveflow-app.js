...
let uberBatches=loadArray(K.uber);
let deliverooOrders=loadArray(K.deliveroo);
let selectedDate=businessToday();
let weekRef=selectedDate, statsRef=selectedDate, historyRef=selectedDate, compareRef=selectedDate;
